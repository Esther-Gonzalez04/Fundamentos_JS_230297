...
//IMPORTANTE: ASSING, NO SOLO PERMITE LA FUSION DE 2 O MÁS OBJETOS, TAMBIEN MUTA LOS OBJETOS ORIGINALES, PERDIENDO AL VALOR ORIGINAL DEL ID EN ESTE CASO
...
//Parchamos el error, reiiciando el valor de producto ID al ORIGINAL
//producto.ID=100;
...
console.log("Fusionamos los 3 objetos en un nuevo, sin perdida de información")
console.log(Venta2)
...
console.log("Vamos a verificar el status de mutabilidad del objeto PEDIDO")
...
console.log("Vamos a verificar el status de mutabilidad del objeto COMPRADOR")
...
console.log("Vamos a verificar el status de mutabilidad del objeto PRODUCTO")
